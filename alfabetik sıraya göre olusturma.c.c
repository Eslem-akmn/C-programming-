/*Dýþarýdan aldýðý isimleri alfabetik sýra ile
listeleyen, listeye yeni düðüm ekleyen, belirtilen
düðümü silen ve düðümdeki en uzun ismi bulan tek
baðlý liste uygulamasý.*/
